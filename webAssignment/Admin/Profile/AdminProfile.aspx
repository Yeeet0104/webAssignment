...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="shadow-lg bg-white p-4 rounded-lg">
        ...
        <div class="flex py-2 ">
            ...
            <div class="pl-2 pr-6 w-1/3 pt-2">
                <div>
                    <asp:Image ID="profilePic" ImageUrl="~\Admin\Layout\image\DexProfilePic.jpeg" class="w-full" Height="300" runat="server" onclick="document.getElementById('<%= fileUpload.ClientID %>').click();"/>
                </div>
    ...
    <!--Change Password-->
    <div class="shadow-lg bg-white p-4 rounded-lg my-5">
