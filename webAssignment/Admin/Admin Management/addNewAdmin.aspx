            ...
            <div class="w-full">
                <div class="flex flex-row pb-4">
                    <div class="w-1/2 pr-8">
                        ...
                        <asp:TextBox ID="txtEditName" runat="server" Text="" class="w-full font-medium bg-gray-100 px-3 py-2 rounded-lg text-lg border-2 border-gray-300"></asp:TextBox>
                    </div>
                    <div class="w-1/2 pl-8">
                        <span class="text-sm font-medium text-gray-600">Email</span>
                        <asp:TextBox ID="txtEditEmail" runat="server" Text="" class="w-full font-medium bg-gray-100 px-3 py-2 rounded-lg text-lg border-2 border-gray-300"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="w-full">
                <div class="pb-10">
                    <div class="w-1/2 justify-start pr-8">
                        <div class="flex flex-col">
                            ...
                            <asp:TextBox ID="txtEditPhoneNo" runat="server" Text="" class="w-full font-medium bg-gray-100 px-3 py-2 rounded-lg text-lg border-2 border-gray-300"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
